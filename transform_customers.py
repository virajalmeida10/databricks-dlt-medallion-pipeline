...
# Converting customer_name into uppercase
# Transforming Customers Data View:
@dlt.view(
...
dlt.create_streaming_table(
    name = "customers_enr"    # Table name
)

dlt.create_auto_cdc_flow(           # Function to create cdc on the table data
    target = "customers_enr",           # Table name
    source = "customers_enr_view",      # Source table name
    keys = ["customer_id"],            # Keys to match the existing data for update
...
# Silver layer is ready after this.